...
if __name__=="__main__":
    ...
    parser.add_argument('--filename', type=str, default='svhn_qbdc', help='csv filename')
    parser.add_argument('--tmp_save', type=str, default='svhn_qbdc_saving', help='csv filename')
